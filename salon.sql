...
ALTER TABLE `appointments`
  ...
  ADD CONSTRAINT `appointments_ibfk_3` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`),
  ADD CONSTRAINT `appointments_ibfk_4` FOREIGN KEY (`service_id`) REFERENCES `services` (`service_id`);
COMMIT;
